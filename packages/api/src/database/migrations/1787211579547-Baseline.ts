...
export class Baseline1787211579547 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "business_connections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "retailer_business_id" uuid NOT NULL, "wholesaler_business_id" uuid NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'pending', "initiated_by_business_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_df56bbbbf78fd6ee4966e194784" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ae26cd58b8b9fd00dcaf8d3995" ON "business_connections"  ("retailer_business_id", "wholesaler_business_id") `);
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "business_id" uuid NOT NULL, "name" character varying(100) NOT NULL, "parent_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_108cff1cf3a679074531948ded" ON "categories"  ("business_id", "name") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_82998c582d28f74cca4eff80a7" ON "product_batches"  ("product_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_ce1ca3414bd02ebe87f640d254" ON "product_batches"  ("business_id") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_db09632a24776c3c96fe93982f" ON "orders"  ("business_id", "client_request_id") `);
        ...
        await queryRunner.query(`CREATE TABLE "order_item_batches" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order_item_id" uuid NOT NULL, "batch_id" uuid NOT NULL, "quantity" numeric(15,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_55682b6df2214e4f1ea5a0a0e59" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8ffb4e6c980ef6dd1148c21427" ON "order_item_batches"  ("batch_id") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_95fbc6cbb15cd2ced7cfb3d615" ON "payments"  ("business_id", "client_request_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0d8deb0e0812b6870852984c81" ON "product_variants"  ("business_id") `);
        ...
        await queryRunner.query(`CREATE TABLE "visits" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "salesman_id" uuid NOT NULL, "customer_id" uuid, "check_in_time" TIMESTAMP, "check_out_time" TIMESTAMP, "gps_location" character varying(100), "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0b0b322289a41015c6ea4e8bf30" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1746ab08e5f7c0b9944fb5f9c2" ON "attendances"  ("business_id", "user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_490a4834ce75b3812a00bcbb1a" ON "attendances"  ("business_id", "date") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_52a56e244d32416a0e541bfd71" ON "commissions"  ("business_id", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_bebeb8e20fe8aa11862a69dbfa" ON "commissions"  ("business_id", "user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "business_connections" ADD CONSTRAINT "FK_edda2bd55b1c34b108865c7c4ab" FOREIGN KEY ("retailer_business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "business_connections" ADD CONSTRAINT "FK_8dbb26793d4fe590f34d0b1af28" FOREIGN KEY ("wholesaler_business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD CONSTRAINT "FK_864a3c8e0aedf9be231c4614ce4" FOREIGN KEY ("linked_business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "device_tokens" ADD CONSTRAINT "FK_641011a87c8bd01845887b19cf1" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "expenses" ADD CONSTRAINT "FK_ef28e0814977f1c47575f0814c7" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tables" ADD CONSTRAINT "FK_a18c9ff572d96d1de4348797a2b" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "suppliers" ADD CONSTRAINT "FK_b03cdb57ba2af2a4d185d8e81f5" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "suppliers" ADD CONSTRAINT "FK_9f1b1c0adcea3da1a9302034e36" FOREIGN KEY ("linked_business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "purchase_items" ADD CONSTRAINT "FK_121744c3063cfae889a37384fe4" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "purchase_items" ADD CONSTRAINT "FK_ecc3a17cde49baab907b7153a74" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "purchase_orders" ADD CONSTRAINT "FK_4ac1ec23b6b7dbbe09358732f61" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_batches" ADD CONSTRAINT "FK_ce1ca3414bd02ebe87f640d2544" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_batches" ADD CONSTRAINT "FK_c877a35c876b116df937f1754f1" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_batches" ADD CONSTRAINT "FK_011591d355c11e2082dce47f11e" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_2e6a9a86c2584e025249f92a0fd" FOREIGN KEY ("last_supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "kot" ADD CONSTRAINT "FK_f3009ab602503f36319583cee58" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "kot" ADD CONSTRAINT "FK_c5f94e2b0e2544c85b942d70177" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "kot" ADD CONSTRAINT "FK_1b3950413381fd1c1a1baa35222" FOREIGN KEY ("table_id") REFERENCES "tables"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD CONSTRAINT "FK_145532db85752b29c57d2b7b1f1" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD CONSTRAINT "FK_9263386c35b6b242540f9493b00" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_items" ADD CONSTRAINT "FK_50eea45069d59addc62f2414c76" FOREIGN KEY ("kot_id") REFERENCES "kot"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_a03a66fe7daff0497b2ef13760a" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_8f96c84343bd7d6cb4374e9788f" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_d831e2cc180e00f582b10bbae31" FOREIGN KEY ("reference_invoice_id") REFERENCES "invoices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice_scan_files" ADD CONSTRAINT "FK_bb58480cd5cbe98bdc5f0ec9c22" FOREIGN KEY ("scan_id") REFERENCES "invoice_scans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" ADD CONSTRAINT "FK_8e19cc56d6331129162c2bf8fdc" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" ADD CONSTRAINT "FK_179f48aa139d494286b55e1f21d" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" ADD CONSTRAINT "FK_e7db54064c3b6d29816236641de" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_scan_items" ADD CONSTRAINT "FK_874d23d83cba15bc5a921f987ca" FOREIGN KEY ("scan_id") REFERENCES "invoice_scans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_scan_items" ADD CONSTRAINT "FK_a4f18856a67087d45876c065990" FOREIGN KEY ("matched_product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ledgers" ADD CONSTRAINT "FK_f35e4d3b924d83c49c61e606471" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ledgers" ADD CONSTRAINT "FK_f833e4a6d9e31768cdc56c63df8" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ledgers" ADD CONSTRAINT "FK_f5f5d70fc7dc2592ca5af38c1a1" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item_batches" ADD CONSTRAINT "FK_103f6f90e64af3b8d6da5914b62" FOREIGN KEY ("order_item_id") REFERENCES "order_items"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_item_batches" ADD CONSTRAINT "FK_8ffb4e6c980ef6dd1148c214276" FOREIGN KEY ("batch_id") REFERENCES "product_batches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_07889d42d0b29705cf4a649576b" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "price_history" ADD CONSTRAINT "FK_c367035ebec7c0115762e71f92e" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_history" ADD CONSTRAINT "FK_ebd3304630b8f13aa9c3cc25510" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "price_history" ADD CONSTRAINT "FK_ebdb4d54c8de7847c0f7a9e4fbb" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_variants" ADD CONSTRAINT "FK_0d8deb0e0812b6870852984c814" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "salesmen" ADD CONSTRAINT "FK_a1e6ba44fd8d654044fd950167e" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "salesmen" ADD CONSTRAINT "FK_1ad5ff6a492223d5f68b8682963" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "stocks" ADD CONSTRAINT "FK_cb1e0f7f972ad427137f6bccebb" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "stocks" ADD CONSTRAINT "FK_a9773f4dd739dc4fc7d4644f932" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_returns" ADD CONSTRAINT "FK_8b047b1ad7450da53bd4be9322b" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_returns" ADD CONSTRAINT "FK_e259919f3bf18a5c54dcac65fd0" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_returns" ADD CONSTRAINT "FK_bc5bd3e261a01539766d9f941b6" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_returns" ADD CONSTRAINT "FK_286897cf8399878c4cabecbbd34" FOREIGN KEY ("purchase_order_id") REFERENCES "purchase_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "visits" ADD CONSTRAINT "FK_47d57b573e94471c611608cc90e" FOREIGN KEY ("salesman_id") REFERENCES "salesmen"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "visits" ADD CONSTRAINT "FK_b88a2340a967b0c834f225609c0" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "waiters" ADD CONSTRAINT "FK_fcd64a1e48a48a41db40af9b087" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "waiters" ADD CONSTRAINT "FK_b33a609508349b636ef9a1dcc22" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "commissions" ADD CONSTRAINT "FK_b1472834a901392bf25e9e4f6a9" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "commissions" ADD CONSTRAINT "FK_dacb8f7c50aca368cf461526d81" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" ADD CONSTRAINT "FK_6bee9b70f24c404c7fafcedad72" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" ADD CONSTRAINT "FK_920697cc0fcd94331e3fa12164a" FOREIGN KEY ("business_id") REFERENCES "businesses"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_activity_logs" DROP CONSTRAINT "FK_920697cc0fcd94331e3fa12164a"`);
        await queryRunner.query(`ALTER TABLE "user_activity_logs" DROP CONSTRAINT "FK_6bee9b70f24c404c7fafcedad72"`);
        await queryRunner.query(`ALTER TABLE "commissions" DROP CONSTRAINT "FK_dacb8f7c50aca368cf461526d81"`);
        await queryRunner.query(`ALTER TABLE "commissions" DROP CONSTRAINT "FK_b1472834a901392bf25e9e4f6a9"`);
        await queryRunner.query(`ALTER TABLE "attendances" DROP CONSTRAINT "FK_aa902e05aeb5fde7c1dd4ced2b7"`);
        await queryRunner.query(`ALTER TABLE "waiters" DROP CONSTRAINT "FK_b33a609508349b636ef9a1dcc22"`);
        await queryRunner.query(`ALTER TABLE "waiters" DROP CONSTRAINT "FK_fcd64a1e48a48a41db40af9b087"`);
        await queryRunner.query(`ALTER TABLE "visits" DROP CONSTRAINT "FK_b88a2340a967b0c834f225609c0"`);
        await queryRunner.query(`ALTER TABLE "visits" DROP CONSTRAINT "FK_47d57b573e94471c611608cc90e"`);
        await queryRunner.query(`ALTER TABLE "supplier_returns" DROP CONSTRAINT "FK_286897cf8399878c4cabecbbd34"`);
        ...
        await queryRunner.query(`ALTER TABLE "supplier_returns" DROP CONSTRAINT "FK_8b047b1ad7450da53bd4be9322b"`);
        await queryRunner.query(`ALTER TABLE "stocks" DROP CONSTRAINT "FK_a9773f4dd739dc4fc7d4644f932"`);
        await queryRunner.query(`ALTER TABLE "stocks" DROP CONSTRAINT "FK_cdcdc9a4b531cbd24c06bc4f9e7"`);
        await queryRunner.query(`ALTER TABLE "stocks" DROP CONSTRAINT "FK_cb1e0f7f972ad427137f6bccebb"`);
        await queryRunner.query(`ALTER TABLE "salesmen" DROP CONSTRAINT "FK_1ad5ff6a492223d5f68b8682963"`);
        await queryRunner.query(`ALTER TABLE "salesmen" DROP CONSTRAINT "FK_a1e6ba44fd8d654044fd950167e"`);
        ...
        await queryRunner.query(`ALTER TABLE "price_history" DROP CONSTRAINT "FK_ebd3304630b8f13aa9c3cc25510"`);
        await queryRunner.query(`ALTER TABLE "price_history" DROP CONSTRAINT "FK_c367035ebec7c0115762e71f92e"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_b2f7b823a21562eeca20e72b006"`);
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_07889d42d0b29705cf4a649576b"`);
        await queryRunner.query(`ALTER TABLE "order_item_batches" DROP CONSTRAINT "FK_8ffb4e6c980ef6dd1148c214276"`);
        await queryRunner.query(`ALTER TABLE "order_item_batches" DROP CONSTRAINT "FK_103f6f90e64af3b8d6da5914b62"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_9a8a82462cab47c73d25f49261f"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_b1b5043ada10de525123ccdd40e"`);
        await queryRunner.query(`ALTER TABLE "ledgers" DROP CONSTRAINT "FK_f5f5d70fc7dc2592ca5af38c1a1"`);
        await queryRunner.query(`ALTER TABLE "ledgers" DROP CONSTRAINT "FK_f833e4a6d9e31768cdc56c63df8"`);
        await queryRunner.query(`ALTER TABLE "ledgers" DROP CONSTRAINT "FK_f35e4d3b924d83c49c61e606471"`);
        await queryRunner.query(`ALTER TABLE "invoice_scan_items" DROP CONSTRAINT "FK_a4f18856a67087d45876c065990"`);
        await queryRunner.query(`ALTER TABLE "invoice_scan_items" DROP CONSTRAINT "FK_874d23d83cba15bc5a921f987ca"`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" DROP CONSTRAINT "FK_e7db54064c3b6d29816236641de"`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" DROP CONSTRAINT "FK_179f48aa139d494286b55e1f21d"`);
        await queryRunner.query(`ALTER TABLE "invoice_scans" DROP CONSTRAINT "FK_8e19cc56d6331129162c2bf8fdc"`);
        await queryRunner.query(`ALTER TABLE "invoice_scan_files" DROP CONSTRAINT "FK_bb58480cd5cbe98bdc5f0ec9c22"`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_d831e2cc180e00f582b10bbae31"`);
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_ea83c3b911906a3578de2340fdf"`);
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_8f96c84343bd7d6cb4374e9788f"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "FK_a03a66fe7daff0497b2ef13760a"`);
        ...
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT "FK_50eea45069d59addc62f2414c76"`);
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT "FK_9263386c35b6b242540f9493b00"`);
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT "FK_145532db85752b29c57d2b7b1f1"`);
        await queryRunner.query(`ALTER TABLE "kot" DROP CONSTRAINT "FK_1b3950413381fd1c1a1baa35222"`);
        await queryRunner.query(`ALTER TABLE "kot" DROP CONSTRAINT "FK_c5f94e2b0e2544c85b942d70177"`);
        await queryRunner.query(`ALTER TABLE "kot" DROP CONSTRAINT "FK_f3009ab602503f36319583cee58"`);
        await queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "FK_2e6a9a86c2584e025249f92a0fd"`);
        ...
        await queryRunner.query(`ALTER TABLE "product_batches" DROP CONSTRAINT "FK_ce1ca3414bd02ebe87f640d2544"`);
        await queryRunner.query(`ALTER TABLE "purchase_orders" DROP CONSTRAINT "FK_d16a885aa88447ccfd010e739b0"`);
        await queryRunner.query(`ALTER TABLE "purchase_orders" DROP CONSTRAINT "FK_4ac1ec23b6b7dbbe09358732f61"`);
        await queryRunner.query(`ALTER TABLE "purchase_items" DROP CONSTRAINT "FK_ecc3a17cde49baab907b7153a74"`);
        ...
        await queryRunner.query(`ALTER TABLE "suppliers" DROP CONSTRAINT "FK_9f1b1c0adcea3da1a9302034e36"`);
        await queryRunner.query(`ALTER TABLE "suppliers" DROP CONSTRAINT "FK_b03cdb57ba2af2a4d185d8e81f5"`);
        await queryRunner.query(`ALTER TABLE "tables" DROP CONSTRAINT "FK_a18c9ff572d96d1de4348797a2b"`);
        await queryRunner.query(`ALTER TABLE "expenses" DROP CONSTRAINT "FK_ef28e0814977f1c47575f0814c7"`);
        await queryRunner.query(`ALTER TABLE "device_tokens" DROP CONSTRAINT "FK_17e1f528b993c6d55def4cf5bea"`);
        await queryRunner.query(`ALTER TABLE "device_tokens" DROP CONSTRAINT "FK_641011a87c8bd01845887b19cf1"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_cde4b2aabca86cfabdc78b537f0"`);
        await queryRunner.query(`ALTER TABLE "customers" DROP CONSTRAINT "FK_864a3c8e0aedf9be231c4614ce4"`);
        ...
        await queryRunner.query(`ALTER TABLE "business_connections" DROP CONSTRAINT "FK_8dbb26793d4fe590f34d0b1af28"`);
        await queryRunner.query(`ALTER TABLE "business_connections" DROP CONSTRAINT "FK_edda2bd55b1c34b108865c7c4ab"`);
        await queryRunner.query(`DROP TABLE "user_activity_logs"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bebeb8e20fe8aa11862a69dbfa"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_52a56e244d32416a0e541bfd71"`);
        await queryRunner.query(`DROP TABLE "commissions"`);
        await queryRunner.query(`DROP TYPE "public"."commissions_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_490a4834ce75b3812a00bcbb1a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1746ab08e5f7c0b9944fb5f9c2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0d8deb0e0812b6870852984c81"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_95fbc6cbb15cd2ced7cfb3d615"`);
        await queryRunner.query(`DROP TABLE "payments"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8ffb4e6c980ef6dd1148c21427"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_db09632a24776c3c96fe93982f"`);
        await queryRunner.query(`DROP TABLE "orders"`);
        await queryRunner.query(`DROP TABLE "order_items"`);
        await queryRunner.query(`DROP TABLE "kot"`);
        await queryRunner.query(`DROP TABLE "products"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ce1ca3414bd02ebe87f640d254"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_108cff1cf3a679074531948ded"`);
        await queryRunner.query(`DROP TABLE "categories"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ae26cd58b8b9fd00dcaf8d3995"`);
