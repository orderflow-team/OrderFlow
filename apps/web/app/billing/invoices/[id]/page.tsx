            ...
            action={
              invoice && (
                <div className="flex gap-2">
                  ...
                  <Button onClick={shareOnWhatsapp} className="gap-1.5 bg-[#25D366] hover:bg-[#1ebd5b] text-white px-4 md:px-5">
                    ...
                    <span className="hidden sm:inline text-[15px] font-medium">Share on WhatsApp</span>
                  </Button>
                </div>
              )
            }
