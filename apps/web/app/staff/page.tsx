...
import { Plus, X, UserCog, KeyRound, Eye, EyeOff, Pencil, Power } from 'lucide-react';
  ...
  return (
    <AppShell>
      <div className="p-6 md:p-10 max-w-5xl mx-auto space-y-8">
        <PageHeader
          title="Staff"
          description="Logins for your Managers, Cashiers, Waiters, Delivery Persons, and Accountants."
          action={
